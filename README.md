<div align="center" style="background-color:#385E8A; color:#FFFFFF; padding:20px; border-radius: 10px;">
  ...
  <p style="margin:0; font-size:1.2em;">Cientista & Analista de Dados</p>
</div>

<div align="center">

Sou um Cientista de Dados apaixonado por transformar dados brutos em soluções de negócio. Meu foco é aplicar machine learning e engenharia de dados para resolver problemas complexos e gerar valor estratégico.

*Atualmente, aprofundando meus conhecimentos em **Cloud (GCP), MLOps e orquestração com Airflow**.*
